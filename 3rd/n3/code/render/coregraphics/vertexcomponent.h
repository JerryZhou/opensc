...
#elif __OSX__
#include "coregraphics/ogl/oglvertexcomponent.h"
namespace CoreGraphics
{
class VertexComponent : public OGL::OGLVertexComponent
{
public:
    /// default constructor
    VertexComponent() { };
    /// constructor
    VertexComponent(SemanticName semName_, IndexT semIndex_, Format format_, IndexT streamIndex_=0) : OGLVertexComponent(semName_, semIndex_, format_, streamIndex_) { };
};
}
#else
