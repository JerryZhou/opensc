...
SysFunc::Setup() {
    if (!SetupCalled) {
        ...
        #if OPENSC_ENABLE_THREADLOCAL_STRINGATOM_TABLES
...
/**
    ...
    will properly shutdown the OpenSC runtime environment, and report 
...
SysFunc::Exit(int exitCode) {
    ...
    #if J_ENABLE_THREADLOCAL_STRINGATOM_TABLES
