...
Float4Test::Run()
{
    ...
    // operators
    v0 = -v0;
    this->Verify(v0 == float4(-1.0f, -2.0f, -3.0f, -4.0f), "can negate its components");
    v0 = -v0;
    this->Verify(v0 == v2);
    v2 += v3;
    ...
    v2.load(f);
    this->Verify(v2 == float4(1.0f, 2.0f, 3.0f, 4.0f), "can load from aligned memory");
    v2.loadu(f);
    ...
    this->Verify((f0[0] == 1.0f) && (f0[1] == 2.0f) && (f0[2] == 3.0f) && (f0[3] == 4.0f));
    v2.stream(f0);
    this->Verify((f0[0] == 1.0f) && (f0[1] == 2.0f) && (f0[2] == 3.0f) && (f0[3] == 4.0f), "can stream to aligned memory");
